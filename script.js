...
function displayCountries(countries){
  ...
  for(let c of countries){
     ...
     <div class="card" style="width: 80%;">
         <img src="${c.flag}" class="card-img-top" alt="" height="200px">
         <div class="card-body">
...
function displayRegions(regions){
  ...
  for(let reg of regions){
    data+=`
    <div>
    <button class="btn btn-outline-info mt-3" onclick="filterCountriesByRegion('${reg}')" value="${reg}">${reg}</button>
</div>
...
function displayCountry(){
 ...
 let htmlData=`
  ...
  <div class="card" style="width: 70%;">
      <img src="${data.flag}" class="card-img-top" alt="" height="200px">
      <div class="card-body">
